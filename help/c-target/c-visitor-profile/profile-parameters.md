...
* Niet volgende items die zijn gemarkeerd in het dialoogvenster [best practices](/help/c-target/c-visitor-profile/profile-parameters.md#section_64AFE5D2B0C8408A912FC2A832B3AAE0) hieronder.
...
* De volgende aanbevelingen kunnen u helpen de ingewikkeldheid van het profielmanuscript beperken. Profielscripts kunnen een beperkt aantal instructies uitvoeren.
   ...
   * Als profielscripts te complex worden, kunt u het volgende gebruiken [reactietokens](/help/administrating-target/response-tokens.md) in plaats daarvan.
...
Profielscripts kunnen de pagina niet rechtstreeks lezen omdat ze aan de serverzijde worden uitgevoerd. De gegevens moeten binnen door een mbox verzoek of door andere worden overgegaan [methoden om gegevens in het doel op te halen](/help/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/methods-to-get-data-into-target.md#concept_0069C0EFB56C4700BB33F2F35C2B9B17). Nadat de gegevens zijn ingevoerd [!DNL Target]profielscripts kunnen de gegevens lezen als een parameter mbox of profielparameter.
...
Maakt een variabele met de naam `adobeQA` om een gebruiker bij te houden voor [Activiteit QA](/help/c-activities/c-activity-qa/activity-qa.md).
