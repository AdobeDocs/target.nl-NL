...
Op het Doel **[!UICONTROL Setup]** > **[!UICONTROL Preferences]** lusje, kunt u Standaard Visuele Composer URL ingaan van de Ervaring.
...
Klik op het **[!UICONTROL Overlays]** pictogram om de manier te wijzigen waarop de markering wordt weergegeven. U kunt bijvoorbeeld alleen afbeeldingen, koppelingen, regionale vakken, wijzigingen of JavaScript markeren. U kunt de kleur van de markering wijzigen. U kunt ook een markeerkleur en een type vulling opgeven waarmee verschillende elementtypen worden gemarkeerd.

![Bedekkingsinstellingen wijzigen](/help/c-experiences/c-visual-experience-composer/assets/change-overlay.png)

Klik op een gemarkeerd element voor een menu met opties die beschikbaar zijn voor dat elementtype. U kunt bijvoorbeeld op een afbeelding klikken en selecteren **[!UICONTROL Edit > Text/HTML]** om de tekst te wijzigen, of op een knop klikken en de achtergrondkleur wijzigen. Met de knoppen linksboven op de pagina kunt u de overlays in- en uitschakelen.

U kunt ook klikken **[!UICONTROL Browse]**, naar een pagina navigeren die vanaf de primaire pagina beschikbaar is, zoals een verzendpagina of winkelwagentje, en wijzigingen op die pagina testen. U kunt ook pagina-elementen openen die beschikbaar zijn wanneer u de muisaanwijzer houdt, zoals vervolgmenu&#39;s en mini-carts. Wanneer u klaar bent met bladeren naar de pagina, klikt u **[!UICONTROL Compose]** om de ervaring te bewerken. U kunt bijvoorbeeld het ontwerp van een keuzelijst met winkelwagentjes of een carrousel met afbeeldingen wijzigen.
...
Terwijl de pagina wordt geladen (of nadat deze niet is geladen), zijn het [!UICONTROL Experiences] deelvenster, [!UICONTROL Modifications] het deelvenster en de instellingen boven aan de ervaring (Bedekkingen, Wijzigingen, Configureren enzovoort) allemaal toegankelijk.
...
Als u het laden van een pagina in de VEC wilt annuleren, klikt u op de **[!UICONTROL Cancel Loading]** knop terwijl de pagina wordt geladen. De pagina wordt tijdens de huidige bewerkingssessie niet in de VEC voor deze activiteit geladen.

![De knop Laden annuleren](/help/c-experiences/c-visual-experience-composer/c-vec-code-editor/assets/cancel-loading.png)

Als u ervaringen met de huidige activiteit wilt blijven beheren of nieuwe wijzigingen wilt toevoegen, moet u op de **[!UICONTROL Reload]** knop klikken.

![Knop Opnieuw laden](/help/c-experiences/c-visual-experience-composer/c-vec-code-editor/assets/reload-in-vec.png)

>[!NOTE]
>
>Er is een bekend probleem met deze functie dat in de volgende release wordt opgelost. Zie &quot;Het laden van een pagina in de VEC annuleren&quot; op de pagina [Bekende problemen en opgeloste problemen](/help/r-release-notes/known-issues-resolved-issues.md#cancel) voor meer informatie.

## Trainingsvideo&#39;s

De volgende video&#39;s bevatten meer informatie over de concepten die in dit artikel worden besproken.

### Videozelfstudie-badge ![voor Visual Experience Composer (1 van 2) (7:17)](/help/assets/tutorial.png)
...
### Videozelfstudie-badge Visual Experience Composer (2 van 2) (7:29) ![](/help/assets/tutorial.png)
