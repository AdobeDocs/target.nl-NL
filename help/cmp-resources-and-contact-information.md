...
description: Meer informatie over extra bronnen voor meer informatie over Adobe [!DNL Target] functies en hoe u contact kunt opnemen met Adobe als u hulp nodig hebt met [!DNL Target].
...
Ga naar [Doelforum van de Gemeenschap](https://forums.adobe.com/community/experience-cloud/marketing-cloud/target) om aan de slag te gaan.
...
[Klik hier voor meer informatie over volgende sessies en registratiegegevens.](https://landing.adobe.com/acs/2018/na/adobe-target/registration.html).
...
Als u zich wilt aanmelden voor volgende sessies en opgenomen sessies wilt bekijken, raadpleegt u [Adobe Customer Care Office-uren](https://helpx.adobe.com/customer-care-office-hours.html).

Huidige opgenomen doelsessies zijn:

| Onderwerp / Runtime / Opnamedatum | Wat u gaat leren |
|--- |--- |
| [tips en overzicht op.js](https://helpx.adobe.com/customer-care-office-hours/target/at-js-1x-Tips-and-Overview.html)<br>59:12<br>26 juni 2019 | U leert:<ul><li>Voordelen van het gebruik van at.js</li><li>at.js-instellingen</li><li>Flikkerverwerking</li><li>Foutopsporing bij.js</li><li>Bekende problemen</li><li>Veelgestelde vragen</li></ul>Zie voor meer informatie [Hoe werkt at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md). |
...
Voor vragen kunt u de Adobe Target-experts in het dialoogvenster [Experience Cloud-gemeenschap](https://forums.adobe.com/community/experience-cloud/marketing-cloud/target) of vraag ons op Twitter op [@AdobeExpCare](https://twitter.com/adobeexpcare).
...
| Accountgegevens | Bedrijfsnaam<br>Beheerdernummer<br>Campagnenaam<br>Type campagne<br>Suite/rapportsuite-id rapporteren (als dit betrekking heeft op de integratie tussen Doel en SiteCatalyst) |
...
Voor problemen met de levering van inhoud raadpleegt u [Problemen met de levering van inhoud oplossen](/help/c-activities/c-troubleshooting-activities/content-trouble.md) voor mogelijke oplossingen en het oplossen van problemeninformatie.

### In geval van uitval {#section_2CB3BC53E4C641F38D50949E2E7A2886}

Als u vermoedt dat er een stroomonderbreking is, controleert u eerst de [Experience Cloud System Status pagina](https://status.adobe.com) ( [!DNL https://status.adobe.com]) Dit heeft een verslag van alle stroomonderbrekingen, incidenten en onderhoud voor de Oplossingen van de Experience Cloud, met inbegrip van Doel, en omvat recentste updates van ons team van TechOps. Als u nog steeds hulp nodig hebt, moet u naast de bovenstaande informatie het volgende weten wanneer u contact opneemt met de klantenservice:
...
Als u geavanceerde meldingen wilt ontvangen over toekomstige productverbeteringen, meldt u zich aan bij de Adobe Priority Product Update:
...
We zijn blij met eventuele suggesties of feedback met betrekking tot deze oplossing. De ideeën en suggesties van de verbetering kunnen aan de [Adobe Target Experience League Community](https://experienceleaguecommunities.adobe.com/t5/adobe-target/ct-p/adobe-target-community). Klik op de knop [!UICONTROL Ideas] tab.
