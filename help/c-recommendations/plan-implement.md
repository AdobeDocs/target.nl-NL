...
|--- |--- |
| Aangepaste globale mabox | (Optioneel) Geef de aangepaste globale box op die wordt gebruikt voor [!DNL Target] activiteiten. Standaard wordt de algemene mbox gebruikt door [!DNL Target} voor [!DNL Recommendations].<br>Opmerking: Deze optie wordt ingesteld op de pagina [!DNL Target] Setup  . Open [!DNL Target], dan klik [!UICONTROL Opstelling]. |
