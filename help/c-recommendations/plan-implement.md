...
|--- |--- |
| Aangepaste globale mabox | (Optioneel) Geef de aangepaste globale box op die wordt gebruikt voor [!DNL Target] activiteiten. Standaard wordt de algemene mbox gebruikt door [!DNL Target} voor [!DNL Recommendations].<br>Opmerking: Deze optie is ingesteld op de [!DNL Target] [!UICONTROL Setup] pagina. Open [!DNL Target], klik dan [!UICONTROL Setup]. |
