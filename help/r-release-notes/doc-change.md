...
| --- | --- | --- |
| 4 augustus | [Target-aankondigingen en -evenementen](/help/r-release-notes/target-announcements.md) | Toegevoegde registratiegegevens over de op 13 augustus geplande webinar &quot;Personalization Strategies Using Artificial Intelligence and Adobe Target&quot;. |
...
| 5 juni | [Target-aankondigingen en -evenementen](/help/r-release-notes/target-announcements.md) | Informatie toegevoegd over het Adobe Target Coffee Break van 10 juni. |
...
| 1 juni | [Target-aankondigingen](/help/r-release-notes/target-announcements.md) | Nieuwe pagina toegevoegd om aanstaande Target-gebeurtenissen aan te kondigen. |
...
| 27 mei | [Opmerkingen bij de release van Target (preRelease)](/help/r-release-notes/target-release-notes.md) | Extra informatie over Analytics for Target (A4T) steun voor auto-Toewijzing activiteiten. |
...
| 21 mei | [Target-randknooppunten Lijsten van gewenste personen](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | Toegevoegd `mboxedge30.tt.omtrdc.net` aan de lijst. |
| 20 mei | [Opmerkingen bij de release van Target (preRelease)](/help/r-release-notes/target-release-notes.md) | Extra informatie over de aanstaande release van Target Standard/Premium 20.6.1 (10 juni 2020). |
|  | [Gastheren](/help/administrating-target/hosts.md) | Opmerking toegevoegd aan de sectie &#39;best practices voor beveiliging&#39;. |
| 14 mei | [Opmerkingen bij de release van Target (huidige)](/help/r-release-notes/release-notes.md) | Toegevoegde informatie over wijzigingen in de profielbatchstatus-API v2. |
...
|  | [Opmerkingen bij de release van Target (preRelease)](/help/r-release-notes/target-release-notes.md) | Gewijzigde datum van de release Target Standard/Premium (20.4.1) in 6 mei. |
...
| 22 april | [Opmerkingen bij de release van Target (preRelease)](/help/r-release-notes/target-release-notes.md) | Nieuwe sectie toegevoegd: *Wijzigingen in de profielbatchstatus-API v2 (4 mei 2020).* |
| 20 april | [Opmerkingen bij de release van Target (huidige)](/help/r-release-notes/release-notes.md) | Nieuwe sectie toegevoegd: *Adobe Target Skill Builder: Chat ontwikkelaar, migrate Adobe Target mbox.js aan at.js.* |
| 14 april | [Target-randhosts Lijsten van gewenste personen](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | Nieuw onderwerp. |
...
|  | [details van de at.js-versie](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | De volgende informatie is toegevoegd aan de gegevens van at.js versie 2.2.0:<ul><li>Probleem verholpen waarbij kliktracking ertoe leidde dat conversies in Analytics for Target (A4T) niet werden gerapporteerd wanneer Adobe Analytics-code niet aanwezig was op pagina-elementen.</li></ul> |
...
| 20 maart | [Opmerkingen bij de release (huidig)](/help/r-release-notes/release-notes.md) | Geeft aan dat de release Target Standard/Premium 20.2.1 23 maart 2020 wordt. |
...
|  | [details van de at.js-versie](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Verduidelijkte tekst die verklaart welke versies van bij.js het team van Target steunen. |
