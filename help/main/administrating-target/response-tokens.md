...
1. Zorg ervoor dat u Platform Web SDK versie 2.6.0 (of later) of versie 1.1 (of later) gebruikt.
   ...
   * **at.js**: Zie [Downloaden om.js](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/implement-target-without-a-tag-manager.html){target=_blank}.
...
Gebruiken [at.js, aangepaste gebeurtenissen](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/atjs-custom-events.html){target=_blank} om te luisteren naar [!DNL Target] reactietokens lezen en erop reageren.
