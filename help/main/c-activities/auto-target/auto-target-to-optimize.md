...
[!UICONTROL Auto-Target] activiteiten in [!DNL Adobe Target] gebruik de geavanceerde machine-educatie om uit veelvoudige hoog-presterende, telleregerichte ervaringen te selecteren om inhoud en aandrijvingsomzettingen te personaliseren. [!UICONTROL Auto-Target] biedt iedere bezoeker de meest toegesneden ervaring op basis van het individuele klantprofiel en het gedrag van eerdere bezoekers met vergelijkbare profielen.
...
Onlangs gebruikte een grote kledinghandelaar een [!UICONTROL Auto-Target] activiteit met tien op productcategorieën gebaseerde ervaringen (plus gerandomiseerde controle) om de juiste inhoud aan elke bezoeker te leveren. &quot;[!UICONTROL Add to Cart]&quot; is gekozen als de primaire optimalisatiemethode. De beoogde ervaringen liepen gemiddeld op met 29,09%. Na het maken van de [!UICONTROL Auto-Target] de activiteit werd op 90 % persoonlijke ervaringen ingesteld .
...
* U kunt niet van een bepaalde activiteit veranderen [!UICONTROL Auto-Target] tot [!UICONTROL Automated Personalization]en omgekeerd.
...
Meer informatie over de onderliggende gegevens en algoritmen [!UICONTROL Auto-Target] en [!UICONTROL Automated Personalization] op de onderstaande link :

| Term | Details |
|--- |--- |
| [Random Forest Algorithm](/help/main/c-activities/t-automated-personalization/algo-random-forest.md) | [!DNL Target]Het belangrijkste personalisatiealgoritme van beiden gebruikt [!UICONTROL Auto-Target] en [!UICONTROL Automated Personalization] is Random Forest. Met methoden zoals Random Forest kunt u meerdere leeralgoritmen gebruiken om betere voorspellende prestaties te verkrijgen dan met elk van de deelleeralgoritmen. Het Random Forest-algoritme in het dialoogvenster [!UICONTROL Automated Personalization] en [!UICONTROL Auto-Target] activiteiten zijn een classificatie, of regressiemethode, die werkt door het aanleggen van een groot aantal beslissingsbomen tijdens de opleiding. |
| [Gegevens uploaden voor [!DNL Target]Persoonlijke algoritmen](/help/main/c-activities/t-automated-personalization/algo-random-forest.md) | Er zijn verschillende manieren om gegevens in te voeren voor [!UICONTROL Auto-Target] en [!UICONTROL Automated Personalization] modellen. |
| [Gegevensverzameling voor [!DNL Target]Persoonlijke algoritmen](/help/main/c-activities/t-automated-personalization/ap-data.md) | [!DNL Target]De personalisatiealgoritmen verzamelen automatisch verschillende gegevens. |
...
|--- |--- |--- |
| **Beoordelen van Persoonlijkheidsalgoritme (50/50)**: Als uw doel het algoritme moet testen, gebruik een 50/50 percenten verdeling van bezoekers tussen de controle en het gerichte algoritme. Deze splitsing geeft de meest nauwkeurige schatting van de lift. Voorgesteld voor gebruik met &quot;willekeurige ervaringen&quot; als controle. | 50% controle / 50% persoonlijke ervaring gesplitst | <ul><li>Maximaliseert nauwkeurigheid van lift tussen controle en gepersonaliseerd</li><li>Relatief minder bezoekers hebben een persoonlijke ervaring</li></ul> |
...
Als u het dialoogvenster [!UICONTROL Control] percentage, klik de pictogrammen in [!UICONTROL Allocation] kolom. U kunt de controlegroep niet tot minder dan 10% verminderen.

![De auto-Doel van de verandering verkeerstoewijzing](/help/main/c-activities/assets/auto-target-control.png)
...
* Als u de volledige set van [!UICONTROL Visual Experience Composer] (VEC)-functies die niet worden ondersteund door [!UICONTROL Auto Personalization]: de aangepaste code-editor, meerdere ervaringssoorten en meer.
