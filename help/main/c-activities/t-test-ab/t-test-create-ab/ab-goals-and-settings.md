...
description: Ontdek hoe u de pagina [!UICONTROL Goals and Settings] kunt gebruiken om A/B-activiteitdoelstellingen te definiëren.
...
In de sectie [!UICONTROL Advanced Settings] van de pagina [!UICONTROL Goals & Settings] kunt u de geavanceerde opties configureren.

Om geavanceerde montages te specificeren, klik het **[!UICONTROL More]** pictogram ( ![&#x200B; Meer pictogram &#x200B;](/help/main/assets/icons/MoreSmallList.svg)) in de [!UICONTROL My Primary Goal] sectie, dan klik **[!UICONTROL Advanced Settings]**.
