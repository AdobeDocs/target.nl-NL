...
Leer hoe u bestaande activiteiten in [!DNL Adobe Target] kunt bewerken, zoals het opslaan van wijzigingen als concepten. Dit artikel behandelt de verschillende methodes beschikbaar in de [!DNL Target] interface voor het wijzigen van activiteiten, of u ervaringen bijwerkt, het aanpassen van het richten van regels, of het vormen van doelstellingen, terwijl het verzekeren van uw veranderingen veilig vóór activering wordt bewaard.
...
## Een activiteit bewerken door de activiteit te openen door op de naam ervan op de pagina [!UICONTROL Activities] te klikken {#section_176180DAD17E40CEA441903F39E0AA1C}
