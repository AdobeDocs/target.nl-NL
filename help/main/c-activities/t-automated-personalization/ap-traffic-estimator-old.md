...
1. Klik op het pictogram **[!UICONTROL Traffic]** op de pagina [!UICONTROL Experiences] van de [!UICONTROL Visual Experience Composer] in een [!UICONTROL Automated Personalization] -activiteit.
