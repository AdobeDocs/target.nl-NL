...
Als uw plaats [[!UICONTROL Platform Web SDK] ](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html) {target=_blank} opgesteld heeft, kunt u zich manueel dwingen uit door een pagina op uw plaats met de `at_qa_mode` parameter met een lege waarde te laden. Bijvoorbeeld:
