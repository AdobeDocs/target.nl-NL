...
description: Leer hoe u de pagina Doelstellingen en instellingen in Adobe gebruikt [!DNL Target] om informatie over de doelstellingen van een Ervaring te specificeren richtend (XT) activiteit.
...
Welke instellingen beschikbaar zijn, is afhankelijk van het gebruik [!DNL Target] of [!DNL Analytics] als gegevensbron.

![pagina Instellingen activiteit](/help/main/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
