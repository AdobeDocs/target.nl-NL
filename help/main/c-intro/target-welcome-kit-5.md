...
title: Waar kan ik inspiratie vinden voor mijn tests en Personalization-inspanningen?
feature: Overview
...
## Idee 2: Doel voor nieuwe bezoekers en herhaal verschillende klanten.
...
Voer verschillende tests van uw websiteontwerp uit om de conversie en betrokkenheid van gebruikers te vergroten. Kijk eerst naar de belangrijkste acties die bezoekers proberen uit te voeren en test dingen als verschillende plaatsing van Vraag aan Acties (CTAs) en verschillende de knoopkleuren van CTA die het voor hen gemakkelijker zouden kunnen maken om die acties te voltooien.
...
## Idea 4: Verbeter de conversie van zoekopdrachten naar gerichte inhoud.
...
## Idea 5: verminder het aantal keren dat nodig is om te converteren.
...
## Idea 6: Laat bezoekers niet tot een dood einde komen.
...
Als uw bedrijf middelen besteedt aan de ontwikkeling van een mobiele app voor iOS, Android of andere apparaten, hoeft u niet alleen maar stil te zitten en te hopen dat gebruikers in de App Store op uw app zullen stummen. In plaats daarvan moet er een degelijke strategie komen voor het promoten ervan. Test verschillende benaderingen om downloads en gebruik van apps te stimuleren. Als uw niet-mobiele site een koppeling heeft om uw app te downloaden, probeert u de doeltreffendheid te testen van een tijdelijke bestemmingspagina die expliciet uw app promoot wanneer bezoekers op uw startpagina aankomen. Stel een omleidingstest in die de helft van uw mobiele verkeer naar uw huidige sitepagina en de andere helft naar de tijdelijke bestemmingspagina filtert.

## Idea 9: Gebruik innovaties voor mobiele apps.

Onderzoek aspecten van smartphone voorbij geolocatie, zoals de versnellingsmeter of gyroscoop. U kunt bijvoorbeeld een ervaring testen die de versnellingsmeter gebruikt om een weergegeven item aan een winkelwagentje toe te voegen door de telefoon te schudden. Test het zelfs voor gebruikers van verschillende merken apparaten, zoals iOS versus Android, om te zien of hun reactie verschilt. Met dergelijke tests kunt u nieuw gedrag van bezoekers ontdekken en overwegen om in toekomstige tests te gebruiken.

## Houd rekening met

Overweeg de volgende ideeën voordat we verdergaan met het volgende hoofdstuk: &quot;Eenvoudig vermijdbare valkuilen&quot;.

### Best practices voor testduur

* Minimale duur van de activiteit: voer een testactiviteit uit gedurende ten minste 14 dagen.
* Minimum Resultaten Vertrouwensniveau: voer een testactiviteit uit tot de resultaten een minimum van 90% betrouwbaarheid bereiken.
* Minimale conversie per ervaring: voer een testactiviteit uit tot er minstens 500 conversies per ervaring zijn.
* Consistentie in resultaten: bevestig de resultaten zijn consistent en stabiel door deze weer te geven in de grafiekweergave in [!DNL Target] .
