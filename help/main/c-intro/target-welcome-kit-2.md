...
Voordat u [!DNL Adobe Target] gaat gebruiken, is het misschien handig om een overzicht op hoog niveau van de oplossing te krijgen. In dit hoofdstuk leert u de belangrijkste mogelijkheden van de oplossing, de merkaanraakpunten waarop u de oplossing kunt gebruiken, implementatieopties, belangrijke gebruikersinterfacefuncties en workflows, beheerfuncties en de rol ervan in het geheel [!DNL Adobe Experience Cloud] . Tenzij deze als [!DNL Adobe Target Premium] -functies worden vermeld, zijn de in dit hoofdstuk beschreven items beschikbaar in zowel [!DNL Adobe Target Premium] als [!DNL Adobe Target Standard] . Voor meer informatie, zie [ Inleiding aan Doel ](/help/main/c-intro/intro.md).

## Capaciteiten en activiteiten

Het testen en personaliseren zijn de twee brede types van mogelijkheden die [!DNL Target] aanbiedt en die u kunt gebruiken wanneer het creëren van een &quot;activiteit&quot;in [!DNL Target]. De term &#39;testen&#39; wordt door elkaar gebruikt en &#39;optimaliseren&#39; en &#39;personalisatie&#39; worden door elkaar gebruikt en &#39;doelbewust&#39;.

In een testactiviteit, vergelijkt u één variatie van een digitale ervaring met één of meerdere andere variaties om te ontdekken dat één die de meeste bezoekers veroorzaakt om een gewenste actie te nemen. [!DNL Target] biedt de volgende testmogelijkheden: A/B-tests, MVT-tests (Multivariate Test) en Automatisch toewijzen.

Met een verpersoonlijkingsactiviteit, levert u een digitale ervaring die aan een specifieke groep bezoekers of aan elke individuele bezoeker wordt aangepast. [!DNL Target] biedt de volgende verpersoonlijkingsmogelijkheden: Experience Targeting, Auto-Target, Automated Personalization en Recommendations.

Voor een diepgaander begrip van wanneer en hoe te om elk vermogen te gebruiken, zie [ de activiteitstypes van het Doel ](/help/main/c-activities/target-activities-guide.md).

| Type activiteit | Details |
| --- | --- |
| A/B-tests | Vergelijk twee of meer variaties van uw ervaringen of aanbiedingen op uw website, of andere digitale klant touchpoint om te zien welke variatie de belangrijkste bedrijfsmaatregelen tijdens een vooraf bepaalde testperiode het meest verbetert. A/B-tests zijn zeer geschikt voor grote wijzigingen, zoals nieuwe webpaginalay-outs, verschillende benaderingen van sitenavigatie of drastisch verschillende behandelingen van afzonderlijke elementen van een digitale ervaring, zoals kopiëren, afbeeldingen en call-to-action-knoppen. [ leer meer ](/help/main/c-activities/t-test-ab/test-ab.md). |
| Automatisch toewijzen | Identificeer de best-presterende ervaring onder twee of meer ervaringen, en wijs automatisch meer verkeer aan de winnaar toe om omzettingen te verhogen terwijl de test blijft lopen en leren. Gebruikt kunstmatige intelligentie aangedreven door [!DNL Adobe Adobe AI]. [ leer meer ](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md). |
| Auto-Target <br> (Premium) | Gebruik Adobe AI in [!DNL Target] om de beste ervaring van meerdere bezoekers te bepalen en te leveren op basis van hun individuele klantprofiel en het gedrag van vorige bezoekers met vergelijkbare profielen. Met Auto-Target kunt u afbeeldingen op schaal aanpassen. [ leer meer ](/help/main/c-activities/auto-target/auto-target-to-optimize.md). |
| Automated Personalization<br> (Premium) | Gebruik geavanceerde computerleeralgoritmen en automatisering aangedreven door [!DNL Adobe Adobe AI] om verschillende combinaties van afbeeldingen, kopieën en andere elementen in een aanbieding te bekijken en de beste combinatie te leveren aan elke bezoeker op basis waarvan de beste zakelijke doelen worden behaald, zoals verhoogde conversies of omzet per bezoeker. [ leer meer ](/help/main/c-activities/t-automated-personalization/automated-personalization.md). |
| Gericht op ervaring (XT) | Lever inhoud aan een specifiek publiek dat op een reeks user-defined regels en criteria wordt gebaseerd. **[!UICONTROL Experience Targeting]** is nuttig om een specifieke ervaring of inhoud te richten aan een bepaald publiek wanneer u begrijpt dat een publiek waardevol is en een goed gevoel heeft van welke ervaring met hen resoneert. [ leer meer ](/help/main/c-activities/t-experience-target/experience-target.md). |
| Multivariate Testing (MV) | Vergelijk alle mogelijke combinaties van elementen op de pagina of digitale ervaring. Dit zijn bijvoorbeeld drie verschillende achtergrondafbeeldingen, twee variaties in de kopie en twee verschillende knopkleuren. MVT bepaalt welke combinatie het beste voor een specifiek publiek presteert en welke elementen het meest van invloed zijn op de resultaten. [ leer meer ](/help/main/c-activities/c-multivariate-testing/multivariate-testing.md). |
| Aanbevelingen <br> (Premium) | Gebruik Adobe AI om automatisch producten of inhoud voor te stellen die uw klanten interessant kunnen maken op basis van hun eerdere activiteiten en die van andere klanten. [ leer meer ](/help/main/c-recommendations/recommendations.md). |

## Kanalen

Met [!DNL Target] kunt u overal digitale ervaringen testen en personaliseren. Dit zijn traditionele digitale aanraakpunten zoals uw website, mobiele site en mobiele app, maar ook op aanraakpunten zoals kiosken, e-mail, IoT-apparaten, gameconsoles en zelfs stemassistenten zoals Alexa en Cortana. Veel bedrijven gebruiken [!DNL Target] op hun website. Uit recent onderzoek blijkt echter dat meer mensen merken van hun mobiele apparaten bezoeken. Het optimaliseren van uw mobiele kanalen is nu essentieel. In het ideale geval sluit u de ervaringen van de bezoeker op al uw aanraakpunten aan voor een naadloze, consistente ervaring.
