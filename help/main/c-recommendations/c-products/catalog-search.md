...
Om toegang te krijgen tot [!UICONTROL Catalog Search] pagina, klikt u op **[!UICONTROL Recommendations]** > **[!UICONTROL Catalog Search]**.

![Pagina Zoeken in catalogus](/help/main/c-recommendations/c-products/assets/catalog-search.png)
...
1. Typ een zoekterm in het dialoogvenster **[!UICONTROL Search Products]** veld.
...
De index van de catalogus wordt automatisch gemaakt wanneer u de eerste feed uploadt en wordt vernieuwd volgens de [gespecificeerd schema](/help/main/c-recommendations/c-products/feeds.md#steps).
...
U kunt de beschikbare filters en kolommen tijdelijk wijzigen op de [!UICONTROL Catalog Search] pagina voor de huidige sessie.
