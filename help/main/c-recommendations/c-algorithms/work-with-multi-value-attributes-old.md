...
U kunt criteria maken met filterregels voor meerdere waarden, zoals alle criteria, via Adobe I/O API&#39;s. Hier ziet u een voorbeeld-API-aanroep om een criterium te maken waarbij het entiteitskenmerk `id` zich in de parameterlijst mbox `favorites` bevindt:
