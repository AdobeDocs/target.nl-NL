...
+ Doel integreren met de Experience Cloud {#integrate}
   ...
   + Doel integreren met Adobe Journey Optimizer (AJO) {#ajo}
      ...
      + [Integreer  [!DNL Adobe Target Recommendations]  en  [!DNL Adobe Journey Optimizer]](/help/main/c-integrating-target-with-mac/ajo/recs-ajo-integration.md)
...
+ Aanbevelingen {#recommendations}
   ...
   + [Aanbevelingen Klassieke documentatie](/help/main/c-recommendations/recommendations-classic-documentation.md)
