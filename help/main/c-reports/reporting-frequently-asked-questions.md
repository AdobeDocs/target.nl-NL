...
* Als u de bovenstaande beste praktijken volgt en de verkeerssplitsing niet in tijd normaliseert, zou u het volgende moeten controleren:
   ...
   * Gebruikt u de nieuwste bibliotheek van at.js? Voor meer informatie over de huidige versie en de bijbehorende versiedetails, zie [ at.js versiedetails ](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html){target=_blank}.
