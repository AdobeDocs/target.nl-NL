...
Voor meer informatie, zie {de knopen van de randrand van het 0} Lijst van gewenste personen Doel [&#128279;](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html){target=_blank} in de *Gids van de Ontwikkelaar van Adobe Target*.
...
* Toegevoegde [&#128279;](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/user-agent-and-client-hints.html){target=_blank} steun van de Hints van de Cliënt van de Agent van 0&rbrace; Gebruiker.
