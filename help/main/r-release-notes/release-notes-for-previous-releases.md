...
Voor meer informatie, zie [&#128279;](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html){target=_blank}  de randknopen van het Doel van de Lijst van gewenste personen  &lbrace;in de *Gids van de Ontwikkelaar van Adobe Target*.
