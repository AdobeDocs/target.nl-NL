...
### Fijne aanpassing aan de door AI aangedreven personalisatie: nieuwe functies in [!DNL Adobe Target] (11 oktober 2022)
...
* [Koppeling Opnemen](https://video.tv.adobe.com/v/347360){target=_blank}
   ...
   * [!UICONTROL A/B Test], [!UICONTROL Multivariate Testing] (MVT), (XT) en geautomatiseerde tests en personalisatie
...
* **[Registreren om de webinar-opname te bekijken](https://real-time-loyalty-activation.dxfieldmarketing.adobeevents.com/){target=_blank}**
...
* [Koppeling Opnemen](https://analytics.dxfieldmarketing.adobeevents.com/){target=_blank}
  ...
  Join Jordan Ison (Hoofd Expert Solution Consultant bij [!DNL Adobe]) om te bespreken:
...
### City National Bank: Nul naar Hero - Starten en schalen van een Personalisatieprogramma (9 juni 2022)
...
Leer beste praktijken bij het opvoeren van verpersoonlijkingsprogramma&#39;s op schaal. Zie hoe Dick&#39;s Sporting Goods gebruikt [!DNL Adobe Target] om topsporters en -merken aan te trekken.
...
* [Koppeling Opnemen](https://video.tv.adobe.com/v/343344){target=_blank}
  ...
  Leer hoe de Nationale Bank van de Stad leverde [!DNL Target] tot:
...
### Aanpassing in realtime met [!DNL Adobe Target]
...
### [!DNL Adobe Target] Skill Builder: chatten over ontwikkelaars, migreren [!DNL Adobe Target]s mbox.js to at.js {#skill-builder}
