...
| 8 april | [ NAAM en Doel ](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/implement-cname-support-in-target) {target=_blank} | Het volgende is bijgewerkt:<ul><li>Alle certificaten zijn RSA SHA-256 en sleutels zijn standaard RSA 2048-bits. Sleutelgroottes groter dan 2048-bits moeten expliciet worden aangevraagd via de klantenservice. (Eerder genoemde sleutelgroottes groter dan 2048-bits werden niet ondersteund.)</li><li>Bijgewerkt bash-script.</li><li>Codefragment voor validatie-uitvoer is bijgewerkt.</li></ul> |
...
|  | [Overzicht beheren [!DNL Target] ](/help/main/administrating-target/administrating-target.md) | Belangrijke opmerking toegevoegd over de vereiste machtigingen voor het bewerken van [!UICONTROL Administration] instellingen.<P>Dezelfde opmerking toegevoegd aan alle artikelen in de [!UICONTROL Administration] sectie. |
...
| 26 maart | [[!DNL Target]  versienota&#39;s (huidig) ](/help/main/r-release-notes/release-notes.md) | Release-opmerkingen toegevoegd voor de [!DNL Target Standard/Premium] 25.3.7-release. |
|  | [Aanbevelingen FAQ](/help/main/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Bijgewerkte FAQ&#39;s om aan te geven dat [!DNL Recommendations] objecten die via API zijn gemaakt, beschikbaar zijn in de [!DNL Target] gebruikersinterface. |
|  | [Verzamelingen](/help/main/c-recommendations/c-products/collections.md) | Volgende opmerking toegevoegd: Verzamelingsregels zijn van toepassing op aanbevelingsitems die worden gegenereerd nadat de criteria zijn uitgevoerd. Ze zijn alleen van invloed op entiteitsaanbevelingen (ER&#39;s) in de uitvoer, niet op de sleutel. |
...
| 13 februari | [[!DNL Target]  versienota&#39;s (huidig) ](/help/main/r-release-notes/release-notes.md) | De release van de [!DNL Target Standard/Premium] 25.2.1-update voor de gebruikersinterface is gewijzigd in 17 februari 2025. |
...
|  | [ Ondersteunde browsers ](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/supported-browsers) {target=_blank} | Informatie toegevoegd over welke browsers worden ondersteund in een Target-implementatie met behulp van de [!DNL Adobe Experience Platform Web SDK]. |
...
| Datum | Onderwerp | Wijzigingen |
|--- |--- |--- |
| 27 januari | [[!DNL Target]  versienota&#39;s (prerelease) ](/help/main/r-release-notes/target-release-notes.md) | Prerelease-opmerkingen toegevoegd voor de volgende updates: <ul><li>[!UICONTROL Activities] update van de gebruikersinterface (6 februari 2025)</li><li>[!DNL Recommendations] update van de gebruikersinterface (7 februari 2025)</li></ul> |
