...
**Laatste bijgewerkte: 29 mei, 2025 ( [ de updates van de Documentatie: zie wat veranderde ](r-release-notes/doc-change.md))**

>[!BEGINTABS]

>[!TAB  Belangrijk ]

**Bijgewerkt doel UI nu volledig uit opgerold**

Vanaf 27 mei 2025 hebben alle klanten toegang tot de nieuwe interface van [!DNL Target] . Vanaf 22 juni 2025 wordt de schakeloptie UI verwijderd en zullen alle gebruikers permanent overstappen naar de bijgewerkte interface, zonder dat er een optie is om terug te keren.
...
Op 29 mei 2025 is deze update uitgebracht en biedt deze nieuwe verbeteringen in de gebruikersinterface en belangrijke documentatieverbeteringen. Duik binnen en ontdek wat nieuw is!
...
>[!TAB  documentatie van het Doel ]

Naast deze handleiding zijn ook de volgende [!DNL Adobe Target] hulplijnen beschikbaar:

- [[!UICONTROL Adobe Target Developer Guide]](https://experienceleague.adobe.com/nl/docs/target-dev/developer/overview){target=_blank}
- [[!UICONTROL Adobe Target Tutorials]](https://experienceleague.adobe.com/nl/docs/target-learn/tutorials/overview){target=_blank}
