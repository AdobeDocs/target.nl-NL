---
keywords: reisanalyse van klanten;analyse van klanten van de reis voor doel;rapporteringsbron van de klantenreis de analysemogelijkheden;de analyse van de klantenreis als rapporteringsbron voor doel;doel rapportering in cja; doel rapportering in Customer Journey Analytics
...
1. Wanneer u de **[!UICONTROL Goals & Settings]** pagina van de workflow voor het maken van activiteiten in drie delen, selecteert u **[!DNL Customer Journey Analytics]** als de bron van de rapportage.
   ...
   ![Customer Journey Analytics als optie voor de bron van de rapportage](/help/main/c-integrating-target-with-mac/cja/assets/cja-as-reporting-source.png)
...
1. Selecteer een sandbox.
   ...
   ![Sandbox selecteren, optie](/help/main/c-integrating-target-with-mac/cja/assets/sandbox.png)
...
1. Geef het doel van de activiteit op.
   ...
   ![Een Customer Journey Analytics-metrische optie gebruiken onder Geel metrisch](/help/main/c-integrating-target-with-mac/cja/assets/goal-metric.png)
...
1. In [!DNL Customer Journey Analytics], over de **[!UICONTROL Connections]** pagina, klikt u **[!UICONTROL Create a new connection]**.
   ...
   ![Nieuwe verbindingskoppeling maken in [!DNL Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/assets/create-connection.png)
...
1. Voeg de **[!UICONTROL Adobe Target Classification Events]** opzoekdataset, dan klik **[!UICONTROL Next]**.
   ...
   ![Dialoogvenster Gegevenssets toevoegen in Customer Journey Analytics](/help/main/c-integrating-target-with-mac/cja/assets/add-datasets.png)
...
1. Vorm uw raadplegingsdataset met de [!UICONTROL Key] veld als &quot;sleutel&quot; en de [!UICONTROL Matching] sleutelveld met het volgende pad:
   ...
   ![Dialoogvenster Adobe Target Classifications-gebeurtenis in Customer Journey Analytics](/help/main/c-integrating-target-with-mac/cja/assets/classifications-events.png)
...
1. Als u uw [!DNL Target] gegevens in [!DNL Customer Journey Analytics], moet u de volgende gebieden van uw Dataset van de Raadpleging als afmetingen toevoegen:
   ...
   * [!UICONTROL Activity ID]
   ...
   ![Opties voor namen en id&#39;s in Customer Journey Analytics](/help/main/c-integrating-target-with-mac/cja/assets/names-and-ids.png){width="600" zoomable="yes"}
...
1. Te gebruiken [!DNL Target] afmetingen in de [!UICONTROL Experimentation] stelt u de volgende contextlabels in:
   ...
   * [!UICONTROL Experience Name], gebruik &quot;Variant van de Experimentatie.&quot;
   ...
   ![Contextlabels in het deelvenster Experimentatie](/help/main/c-integrating-target-with-mac/cja/assets/context-labels.png){width="600" zoomable="yes"}
