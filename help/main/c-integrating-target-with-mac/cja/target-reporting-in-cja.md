...
1. Maak in [!DNL Customer Journey Analytics] een deelvenster Experimentatie en selecteer vervolgens de activiteit in het vervolgkeuzemenu **[!UICONTROL Experiment]** .
   ...
   Voor meer informatie, zie [&#128279;](https://experienceleague.adobe.com/nl/docs/analytics-platform/using/cja-workspace/panels/experimentation?lang=en#use){target=_blank} het paneel van de Experimentatie van 0&rbrace; onder *het paneel van de Experimentatie* in de *[!DNL Customer Journey Analytics]* gids.
