...
Voor meer informatie over ondersteunde browsers en hun versies raadpleegt u [Ondersteunde browsers](https://developer.adobe.com/target/before-implement/supported-browsers/){target=_blank}.
...
Omdat voor de interface Target Standard/Premium al een [moderne webbrowser](https://developer.adobe.com/target/before-implement/supported-browsers/){target=_blank}, we verwachten geen problemen. Als u geen verbinding kunt maken met Target, moet u de browser upgraden naar de meest recente versie.
