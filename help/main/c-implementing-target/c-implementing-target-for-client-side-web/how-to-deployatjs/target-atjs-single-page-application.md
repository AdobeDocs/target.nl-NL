...
![Traditionele levenscyclus van pagina&#39;s versus SPA levenscyclus](/help/main/c-experiences/assets/trad-vs-spa.png)
...
at.js 2.x heeft een nieuwe API toegevoegd [triggerView()](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-triggerview-atjs-2.md) functie. U moet `triggerView()` om at.js te laten weten dat een weergave begint met renderen.
...
Hoewel in deze voorbeelden JavaScript-code wordt gebruikt, kan dit alles worden vereenvoudigd als u een tagbeheer gebruikt, zoals tags in [Adobe Experience Platform](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md).
...
### Begrijpen hoe at.js 2.x werkt ![Overzicht badge](/help/main/assets/overview.png)
...
### Implementeren bij .js 2.x in een SPA ![Zelfstudie-badge](/help/main/assets/tutorial.png)
