---
keywords: implementatie;javascript-bibliotheek;js;atjs;apparaatbeslissingen;apparaatbeslissingen;regelartefact
description: Leer over het JSON-regelartefact dat door apparaatbeslissingen wordt gebruikt.
...
# Artefact van de regel voor apparaatbeslissingen

De regel is een JSON-weergave van uw [!DNL Adobe Target] beslissingsactiviteiten op het apparaat. De regelartefact wordt gegenereerd door [!DNL Target] en doorgegeven aan de Akamai CDN om er zeker van te zijn dat er een regelartefact beschikbaar is die zo dicht mogelijk bij uw bezoekers ligt. De regelartefact bevat metagegevens die ervoor zorgen dat uw activiteiten exact worden uitgevoerd en uitgevoerd, terwijl er ook realtime analyses mogelijk zijn via het bijhouden van gebeurtenissen.

Dit is een voorbeeld van een JSON-regelartefact:
