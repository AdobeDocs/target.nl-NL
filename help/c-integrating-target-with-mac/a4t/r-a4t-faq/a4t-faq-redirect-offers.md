...
title: Omleidingsvoorstellen - Veelgestelde vragen A4T
...
# Aanbiedingen omleiden - A4T veelgestelde vragen{#redirect-offers-a-t-faq}
...
Ja, op voorwaarde dat uw implementatie [!DNL at.js] gebruikt. Uw implementatie moet echter voldoen aan de hieronder vermelde minimumvereisten om [aanbiedingen omleiden](/help/c-experiences/c-manage-content/offer-redirect.md#task_33C80CD722564303B687948261484F94) te kunnen gebruiken in activiteiten die Analytics als rapportagebron gebruiken.
...
Met [!DNL at.js] versie 0.9.6 (of later) en [!DNL AppMeasurement.js] 2.1 (of later), zal het [!DNL Analytics] verzoek op de nieuwe pagina een verwijzende URL van [!DNL `www.google.com`] melden.
