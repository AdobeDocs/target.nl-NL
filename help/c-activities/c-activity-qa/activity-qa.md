...
* De koppeling [!UICONTROL Activity QA] wordt weergegeven op de pagina [!UICONTROL Overview] van alle typen activiteiten, behalve Automated Personalization (AP).
...
* Als u at.js 1 hebt.*x*, de wijze van QA van de Activiteit zal niet kleven als u Safari of een andere browser gebruikt die derdekoekjes blokkeert. In deze gevallen moet u de voorvertoningsparameters toevoegen aan elke URL waarnaar u navigeert. Het zelfde is waar als u [CNAME](/help/c-implementing-target/c-considerations-before-you-implement-target/implement-cname-support-in-target.md) hebt uitgevoerd.
