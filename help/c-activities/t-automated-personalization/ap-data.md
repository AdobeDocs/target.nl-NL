...
# ![PREMIUM](/help/assets/premium.png) -gegevensverzameling voor Target-verpersoonlijkingsalgoritmen{#data-collection-for-the-target-personalization-algorithms}

Target verzamelt en gebruikt automatisch een verscheidenheid aan gegevens om zijn verpersoonlijkingsalgoritmen in de activiteiten Automated Personalization (AP) en Auto-Target (AT) te bouwen. Wanneer een bezoeker de AP of activiteit van AT ingaat, wordt een momentopname van informatie overgegaan tot een reeks &quot;opleidingsverslagen&quot;(de bezoekersgegevens die de verpersoonlijkingsalgoritmen zullen leren).

Zie [Random Forest Algorithm](../../c-activities/t-automated-personalization/algo-random-forest.md#concept_48F3CDAA16A848D2A84CDCD19DAAE3AA)voor meer informatie over de Target-verpersoonlijkingsalgoritmen.

De volgende lijst toont de gegevens die door Geautomatiseerde Personalisatie en auto-Target door gebrek worden verzameld, zonder de teler te moeten doen wat, evenals de noemende overeenkomst wordt gebruikt om deze attributen in de Rapporten [van de](../../c-reports/c-personalization-insights-reports/personalization-insights-reports.md#concept_A897070E1EDC403EB84CFB7A6ECAD767)Inzichten van de Personalisatie te wijzen. U kunt de invoergegevensset op elk gewenst moment uitbreiden. Zie Gegevens [uploaden voor Target-algoritmen](../../c-activities/t-automated-personalization/uploading-data-for-the-target-personalization-algorithms.md#concept_85EA505B37E54514A1C8AB91553FEED6)voor meer informatie over het uploaden van aanvullende gegevens.
...
| Profielkenmerken | Profielscripts of -kenmerken die rechtstreeks via de update-API naar het Target-profiel zijn geüpload | `Custom - Visitor Profile - [attribute name]` | Aangepaste gegevens |
| URL-parameters verwijzen | Over het algemeen is de verwijzende URL de URL die verwijst naar een bepaalde pagina die de Target-aanroep heeft geïnitieerd.<br>Deze variabele kan worden beïnvloed door de gebruikersactiviteit op uw site en de technische implementatie van uw site. | `Custom - [Referring URL Parameter] - [Parameter value]` | Aangepaste gegevens |
...
| URL-parameters | Target inspecteert de URL om de URL-parameters te extraheren. | `Custom - URL Parameter - [URL Parameter]` | Aangepaste gegevens |
...
| Bezoekersprofiel - Eerste bezoek | Geeft de tijd aan van het eerste bezoek dat de gebruiker met Target heeft uitgevoerd. | Dubbele milliseconden |
...
| Bezoekersprofiel - Laatste Target-interactie | Geeft de tijd van de laatste interactie met Target aan. Er vindt interactie plaats bij elk [!DNL Target] verzoek, omdat het profiel bij elke aanvraag door de huidige implementatie wordt [!DNL Target] bijgewerkt. | Dubbele milliseconden |
...
| Bezoekersprofiel - Paginaweergaven in huidig bezoek | Hiermee geeft u het aantal paginaweergaven op in de huidige bezoek/sessie totdat de bezoeker de activiteit start. Meer in het bijzonder het aantal indrukken. Deze afbeeldingen zijn geen echte paginaweergaven, maar het aantal keren dat de aanvraag bij Target is ingediend. Target kan geen onderscheid maken tussen time-outs of andere redenen waarom de gebruiker de inhoud niet heeft ontvangen of bekeken. | Dubbel (alleen geheel getal positief) |
| Bezoekersprofiel - Begin van huidig bezoek | Hiermee geeft u de tijd op waarop het huidige bezoek/de huidige sessie met Target is gestart. Het bezoek aan Target kan worden aangevat zonder een activiteit uit te oefenen. Alles wat vereist is, is een aanroep naar elk [!DNL Target] verzoek. Een bezoeker kan enige tijd duren voordat de activiteit wordt betreden en de opname wordt gemaakt. | Dubbele milliseconden |
| Bezoekersprofiel - Begin van het meest recente bezoek | Hier geeft u de tijd op waarop het laatste bezoek/de laatste sessie met Target is gestart. Dit kenmerk wordt bijgewerkt wanneer de sessie verloopt.<br>Als dit de eerste sessie voor de bezoeker is, resulteert dit in `LAST_SESSION_START = 0.` | Dubbele milliseconden |
