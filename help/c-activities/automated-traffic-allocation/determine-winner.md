...
>[!NOTE]
>
>Voor algemene informatie over het opgeven van een winnaar raadpleegt u [Tien gemeenschappelijke A/B-testvalkuilen en hoe deze te vermijden](/help/c-activities/t-test-ab/common-ab-testing-pitfalls.md).
...
Zie voor meer informatie over deze en andere beperkingen en opmerkingen [Automatisch toewijzen](/help/c-integrating-target-with-mac/a4t/a4t-at-aa.md#aa) in *A4T-ondersteuning voor [!UICONTROL Auto-Allocate] en [!UICONTROL Auto-Target] activiteiten*.
