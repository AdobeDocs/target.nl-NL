...
description: Download een interactieve PDF die de verschillende activiteitstypen in Adobe Target beschrijft (met uitzondering van Aanbevelingen).
...
Download een interactieve PDF die de verschillende activiteitstypen in Adobe Target beschrijft (met uitzondering van Aanbevelingen).
...
| Geautomatiseerde Personalisatie (AP) | Een manier om een reeks aanbiedingen (gemaakt of vooraf gedefinieerd, in elementen op één pagina of op meerdere pagina&#39;s) aan te passen en aanbiedingscombinaties te leveren die het beste werken om specifieke bezoekers aan te trekken. |
| MVT (Multivariate Testing) | Een manier om veelvoudige aanbiedingen in veelvoudige elementen te tonen, en dan de resulterende unieke ervaringen tegen een specifiek doel gelijktijdig te testen, dat helpt bepalen welke elementvariatie het meest succesvol is, en ook potentieel openbaren welke elementen de grootste positieve of negatieve invloed op de interactie van een bezoeker hebben. |
...
| Geautomatiseerde Personalisatie (AP) | Heeft een of meer voorstellen.<br/>Wil combinaties aanbieden die optimale gepersonaliseerde ervaringen voor specifieke bezoekers over een verscheidenheid van unieke profielen en gedrag produceren. |
| MVT (Multivariate Testing) | Heeft kennis van status.<br/>Heeft een of meer voorstellen.<br/>Wil conversietrends met betrekking tot interacties van pagina-elementen analyseren. |
...
| Geautomatiseerde Personalisatie (AP) | Het optimalisatiemechanisme past voortdurend aan welke ervaringen bezoekers krijgen op basis van nieuw bezoekersgedrag en gedrag van vergelijkbare bezoekers in het verleden, waarbij de prestaties van een aanbieding worden gemeten aan de hand van gelijktijdige controlegroepen. |
| MVT (Multivariate Testing) | De test helpt de relatieve invloed van specifieke elementen op de conversie aan het licht te brengen. |
...
| Automatisch doel | Met Auto-Target wordt het leren van machines toegepast op om het even welk soort ervaring, met inbegrip van multi-paginagenervaringen. Het staat u ook toe om de waarde van Geautomatiseerde Personalisatie te bereiken terwijl het gebruiken van het vertrouwde A/B testende werkschema. | Met Auto-Doel, als u de inhoud van uw aanbiedingen vaak of vaak wilt veranderen, zal het algoritme genoeg tijd na elke verandering nodig hebben om te exploiteren wat het leert en daadwerkelijk die inhoud aan de juiste bezoekers te leveren.</br>AutoDoel kan geen rapporten in A4T verbruiken. |
| Geautomatiseerde Personalisatie (AP) | Met Geautomatiseerde Personalisering, kunt u al uw aanbiedingen op één plaats verzamelen, en het algoritme toont eenvoudig de beste combinatie van hen. U hoeft geen afzonderlijke ervaringen op te geven of samen te stellen. Automatische personalisatie gebruikt dezelfde leeralgoritmen voor machines als Auto-Target. | Wanneer u veelvoudige aanbiedingen combineert, komt een combinatoriale explosie voor resulterend in de behoefte aan een significante hoeveelheid verkeer. Het algoritme van de geautomatiseerde Personalisering verklaart een grote hoeveelheid factoren; de meeste verkeersbehoefte.</br>Geautomatiseerde Personalisatie kan geen rapporten in A4T verbruiken. |
| MVT (Multivariate Testing) | Met het Meervoudig Testen, kunt u veelvoudige elementen gelijktijdig testen. | Een multivariate test is tijdrovend, en door de veelvoudige variabelen bij spel, veroorzaakt het niet noodzakelijk een het winnen Ervaring met vertrouwen.</br>Het is vaak uitdagend om de hoeveelheid verkeer te bereiken nodig om de test te voltooien. Aangezien alle experimenten met multivariate-tests volledig rekening houden, kunnen te veel veranderende elementen in één keer snel een zeer groot aantal mogelijke combinaties optellen die moeten worden getest.</br>Zelfs een plaats met vrij hoog verkeer zou problemen kunnen hebben die een test met meer dan 25 combinaties in een uitvoerbare hoeveelheid tijd voltooien. |
