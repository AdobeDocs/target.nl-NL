...
description: Leer hoe te om Visual Experience Composer (VEC) in Adobe te gebruiken [!DNL Target] om een Ervaring te creëren richtend (XT) activiteit op een doel-Toegelaten pagina.
