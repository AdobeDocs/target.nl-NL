...
description: Het Doel van Adobe bepaalt welke activiteit (of activiteiten) om aan een pagina te leveren verschillend afhankelijk van welke interface van het Doel en welke functie van de activiteitenverwezenlijking (Visuele Composer van de Ervaring of Vorm Gebaseerde composer) u gebruikt.
...
## Alleen doelstandaard/Premium Visual Experience Composer of op formulier gebaseerde Composer die alleen Global mbox gebruikt {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. De servervraag van het doel komt aan Doel met informatie over mbox en URL.
1. Doel: Klassieke en Standaard trek elke activiteit die in die box wordt uitgevoerd.
1. Doelpogingen om de bezoeker in activiteiten aan te passen.
...
## Doelstandaard/Premium op formulier gebaseerde composer met niet-globale Mboxen {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}

>[!NOTE]
>
>Deze informatie is ook van toepassing op alle campagnes die worden uitgevoerd en die zijn gemaakt in Target Classic.

Als uw bedrijf andere vakjes dan globale mbox in op vorm-gebaseerde composer gebruikt, kan de inhoud van slechts één activiteit per vraag worden teruggekeerd. De levering van de activiteit wordt bepaald gebruikend de volgende beslissingsstroom:

1. De de servervraag van het Doel komt aan Doel met informatie over mbox en URL.
1. Het doel trekt elke activiteit die in dat mbox loopt.
1. Het doel probeert om de bezoeker in de hoogste prioritaire activiteit aan te passen.
...
**Twee Klassieke doelcampagnes gebruiken niet-globale dozen**
