...
1. Klik **[!UICONTROL Activities]** en klik vervolgens in de lijst op de gewenste activiteit.
   ...
   In de volgende afbeelding ziet u de [!UICONTROL Type] vervolgkeuzelijst met twee geselecteerde typen: [!UICONTROL A/B Test] en [!UICONTROL Experience Targeting]. De drie typen A/B-tests (Handmatig, [Automatisch toewijzen](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md)en [Automatisch](/help/c-activities/auto-target/auto-target-to-optimize.md)) zijn standaard geselecteerd. U kunt desgewenst een of meer typen deselecteren.
