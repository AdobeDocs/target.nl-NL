...
1. Werk uw [!DNL Target] implementatie bij met de implementatiecode die in de vorige stap is verkregen.
   ...
   * **Via een &quot;globale parameter&quot; in [!DNL Dynamic Tag Management]:**
      ...
      Voor meer informatie, zie [Globale Parameters - Adobe Target](https://experienceleague.adobe.com/docs/dtm/using/tools-reference/target.html#global-parameters---adobe-target) in de *Dynamische Documentatie* van het Product van het Beheer van de Markering.
