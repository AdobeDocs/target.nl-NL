...
1. Meld u aan bij de Adobe Experience Cloud en klik op **[!UICONTROL Link Account]**.
   ...
   Alle Experience Cloud-producten worden op de koppelingspagina weergegeven. Klik `Link Target` en ga uw gebruikersbenaming en wachtwoord van het Doel in om tot de Standaard van het Doel toegang te hebben.
