...
**Hoe kan ik zien hoe andere klanten Adobe Target hebben gebruikt voor betere resultaten?**
...
**Beschikt Adobe over een Community/Forum waar ik antwoorden en meer informatie over Target kan vinden?**

Ontdek het [Target Community Forum](../cmp-resources-and-contact-information.md#concept_9C203A8AED054DFFA9A504811DB6BA42), waar wij klanten helpen, maar belangrijker nog, wij houden van Adobe Target-professionals zoals u om elkaar te helpen. Het succes van een gemeenschap en forum hangt immers af van actieve deelname van haar leden. Word een lid van de gemeenschap en draag bij en zoek antwoorden op uw vragen.
...
Alle bestaande mbox.js-klanten moeten migreren naar at.js. Meer informatie over de stappen die nodig zijn voor het [migreren van mbox.js naar at.js](../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-target-atjs-implementation/target-migrate-atjs.md#task_DE55DCE9AC2F49728395665DE1B1E6EA) voordat u de overgang maakt.
...
Gebruik [A/B Testen](../c-activities/t-test-ab/test-ab.md#task_05E33EB15C4D4459B5EAFF90A94A7977) (optie Handmatig gericht) samen met de [calculator](../c-activities/t-test-ab/sample-size-determination.md#section_286EB6E671184239BB1552F0387DAEB5) van de Grootte van de Steekproef voor beste resultaten.

**Hoe weet ik wanneer ik een activiteit stop?**

Voortijdig stoppen van activiteiten kan leiden tot verkeerde conclusies. Wees op de hoogte van [gemeenschappelijke valkuilen en zorg ervoor dat deze](../c-activities/t-test-ab/common-ab-testing-pitfalls.md#section_DF01A97275E44CA5859D825E0DE2F49F)worden voorkomen. Zie ook: [Hoe lang moet u een A/B-test](/help/c-activities/t-test-ab/sample-size-determination.md)uitvoeren?

**Hoe kan ik een activiteit uitvoeren als het time-window klein is?**

**Kan ik optimaliseren voor mijn doel terwijl ik test?**

Gebruik onze [rapporten om de winnende ervaring](../c-activities/automated-traffic-allocation/determine-winner.md#concept_5741A89ED7224E1285A3BC34B2CCD0F9)te bepalen.
...
Lees de [doelhandleiding](../c-activities/target-activities-guide.md#concept_D974B0918EB74B3B8CB07ACD32BF37A1) voor activiteiten om te begrijpen in welke scenario&#39;s elk van de opties van Adobe Target zinnig is.
...
Bekijk onze [Full Factorial Multivariate (MVT) activiteiten](../c-activities/c-multivariate-testing/multivariate-testing.md#concept_628695CDC71B449B8DCC2F5654C11499) met de analyse van de bijdrage van het Element om te zien of beantwoordt het aan uw behoeften.
...
Probeer de [functie](../c-experiences/c-visual-experience-composer/multipage-activity.md#concept_277E096063E14813AC5D8EDFA1D2ED48) Meerdere pagina&#39;s activiteit uit, waarmee u meerdere pagina&#39;s kunt gebruiken binnen een ervaring.
...
Dit kunt u eenvoudig bereiken met de optie [Geavanceerde instellingen](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#section_E2FE441AFB324E498793ABB025ED9974) die bij elk doel beschikbaar is. U kunt kiezen wat er moet gebeuren als de gebruiker het doel heeft bereikt en hoe u het tellen wilt verhogen.
...
Daar komen [doelstellingen](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#reference_B25389FD6F3A4989801E740364B089CC) bij.
...
Gebruik de functie [Planning in de stap Doelstellingen en Instellingen](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#section_DCBDC354261F420EBD4B43EA34947BAC) van de driedelige workflow door de begin- en einddatum op te geven.
...
U kunt dat gemakkelijk doen door de gewenste stap van uw keus van de pagina [van het Overzicht van de Activiteit](../c-activities/edit-activity.md#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0) direct in te gaan en dan uit die stap weg te gaan door sparen en te sluiten optie te gebruiken.
...
Dat is ook mogelijk. Met de optie Opslaan [kunt u eenvoudig stapsgewijze wijzigingen aanbrengen zonder de stap](../c-activities/edit-activity.md#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0)te verlaten.
...
* Aangepast, met een bereik van 0 tot en met 999. Schakel onder Aangepast de functie Prioriteiten met fijnkorrelige korrel in (Instellen > Voorkeuren).
...
Begin gebruikend onze [activiteit-Enige eigenschap](../c-target/creating-activity-only-audience.md#concept_A6BADCF530ED4AE1852E677FEBE68483) van het Publiek om publiek te bepalen dat aan de activiteit lokaal is.

**Hoe kan ik gebruikers richten die op hun plaatsen worden gebaseerd?**

Probeer [Geo-publiek](../c-target/c-audiences/c-target-rules/geo.md#concept_5B4D99DE685348FB877929EE0F942670)uit. Lees meer over de nauwkeurigheidsniveaus van deze functie.

**Kan ik gebruikers richten die op sommige attributen op de pagina in de zitting worden gebaseerd?**

De beste manier zou zijn om dozen en [douanepubliek](../c-target/c-audiences/c-target-rules/custom-parameters.md#concept_C4C6E00D7C5A4BE9B72D471DB2E3027B) te gebruiken om de juiste ervaring te leveren.
...
Probeer de functie [Profielscripts](../c-target/c-visitor-profile/profile-parameters.md#concept_8C07AEAB0A144FECA8B4FEB091AED4D2). Het is een krachtige manier om ervaringen te personaliseren, hoewel het vereist dat u code schrijft.
...
**Ik heb ook Adobe Analytics en wil deze functie gebruiken met Target. Welke belangrijke mogelijkheden krijg ik door de twee oplossingen te integreren?**
...
Bekijk de regels [voor](../c-experiences/c-visual-experience-composer/temtest.md#task_2539D51A18044F82B0D9895636546781) sjablonen om veel vergelijkbare gestructureerde pagina&#39;s toe te voegen aan de activiteit terwijl u de ervaring nog steeds creëert op de opgegeven enkele URL.
...
Probeer de functie [Mobiele Viewports](../c-experiences/c-visual-experience-composer/mobile-viewports.md#concept_8E45527C4ABC41D59AA3553BEDC76FA5) uit. Het werkt alleen als de Enhanced Experience Composer is ingeschakeld.
...
U kunt altijd de standaardinstelling overschrijven met de optie [Enhanced Experience Composer op activiteitsniveau](../c-experiences/experiences.md#section_34265986611B4AB8A0E4D6ACC25EF91D) (Instellen > Voorkeuren).
...
Dit kunt u eenvoudig bereiken met onze functie [Meerdere ervaringsversies](../c-activities/t-test-ab/t-test-create-ab/target-experience-to-multiple-audiences.md#task_0138112E283A4A5B9F8AB9AAF2FBC2FF). Noteer de nuances over de levering in dergelijke tests

**Hoe kan ik zien welke wijzigingen ik in Visual Experience Composer (VEC) heb aangebracht?**

Wijzigingen worden altijd weergegeven in de [Code-editor](../c-experiences/c-visual-experience-composer/c-vec-code-editor/vec-code-editor.md#concept_B3A6E9EE3A60406DB640E205EA1745B5). Op het tabblad Wijzigingen ziet u de CSS-kiezer of het selectievakje dat u op uw aanbieding hebt toegepast.
...
Een van de manieren is om de [aangepaste code-editor](../c-experiences/c-visual-experience-composer/c-vec-code-editor/vec-code-editor.md#concept_B3A6E9EE3A60406DB640E205EA1745B5)te gebruiken. Plaats uw JavaScript in de sectie en deze wordt geleverd. U hebt de optie om het in het hoofd of boven aan het lichaam te leveren, afhankelijk van uw behoeften.
...
We hebben de functie [](../c-experiences/c-manage-content/offer-redirect.md#task_33C80CD722564303B687948261484F94) URL omleiden waarmee u gebruikers kunt omleiden naar de gekozen pagina (met of zonder de huidige queryparameters).
...
Dit is waar het [publiek voor de eigenschap](../c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md#section_13119392051044FBA6387D9B3B1C43CF) van de Rapportering beschikbaar op de pagina van Doelstellingen en van Montages in Stap 3 van het driedelige geleide activiteitenwerkschema binnen komt.
...
Dit is waar [Analytics voor Doel (A4T)](../c-integrating-target-with-mac/a4t/a4t.md#concept_7540C8C04259434AB6EE33B09F47A1DE) handig is. Als u Adobe Analytics hebt, kiest u de bron gewoon als Analytics, waardoor deze beperking wordt opgeheven. Nu kunt u analyse op om het even welk publiek op om het even welk punt uitvoeren en u te hoeven niet om het rapporteringspubliek op voorgrond te bepalen.

**Kan ik offline rapporteringsberekeningen uitvoeren?**

Gebruik de opties [Rapporten](../c-reports/downloading-data-in-csv-file.md#concept_3F276FF2BBB2499388F97451D6DE2E75) exporteren naar CSV en Order Details downloaden naar CSV op de pagina Rapporten om de gewenste rapportgegevens te downloaden.
...
Breng deze wijzigingen aan met het gereedschap [Instellingen op de pagina](../c-reports/c-report-settings/report-settings.md#concept_4BB6A7FDAB6F4806A632F9CD989B8BFA)Rapporten. Lees meer over deze instellingen om te begrijpen hoe de berekeningen variëren.
...
**Kan ik een integratie uitvoeren met een systeem van derden, zoals Google Analytics of ClickTale, om de activiteiteninformatie door te geven die aan een eindgebruiker voor analyse wordt geleverd?**
...
**Hoe weet ik de beschikbaarheidsstatus van Adobe Target?**

Gebruik de [Adobe System Status pagina](../r-release-notes/system-status-updates.md#concept_5CBDF506BEFA40E483CC7DE0DA915EAD) om de status van Adobe-producten en Experience Cloud-oplossingen, inclusief Target, weer te geven. Deze pagina helpt u bepalen of de problemen u zouden kunnen ontmoeten toe te schrijven aan systeemupdates of routineonderhoud.
