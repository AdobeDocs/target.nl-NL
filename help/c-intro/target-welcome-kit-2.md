...
Testen en personalisatie zijn de twee brede soorten mogelijkheden die [!DNL Target] biedt en die u kunt gebruiken bij het maken van een &quot;activiteit&quot; in [!DNL Target]. De term &#39;testen&#39; wordt door elkaar gebruikt en &#39;optimaliseren&#39; en &#39;personalisatie&#39; worden door elkaar gebruikt en &#39;doelbewust&#39;.
...
Voor een diepgaander inzicht in wanneer en hoe te om elk vermogen te gebruiken, zie [de types van activiteit van het doel](/help/c-activities/target-activities-guide.md).
...
| Auto-Target<br>(Premium) | Gebruik Adobe Sensei AI in [!DNL Target] om de beste ervaring van verscheidene aan elke bezoeker te bepalen en te leveren op basis van zijn of haar individuele klantenprofiel en het gedrag van vorige bezoekers met gelijkaardige profielen. Met Auto-Target kunt u afbeeldingen op schaal aanpassen. [Meer](/help/c-activities/auto-target/auto-target-to-optimize.md) informatie. |
...
U kunt [!DNL Target] gebruiken om digitale ervaringen te testen en te personaliseren enkel over om het even waar - traditionele digitale aanraakpunten zoals uw website, mobiele plaats, en mobiele app, maar ook op aanraakpunten zoals kiosken, e-mail, apparaten IoT, spelconsoles, en zelfs stemmedewerkers zoals Alexa en Cortana. Veel bedrijven gebruiken [!DNL Target] op hun website. Uit recent onderzoek blijkt echter dat meer mensen merken van hun mobiele apparaten bezoeken. Het optimaliseren van uw mobiele kanalen is nu essentieel. In het ideale geval koppelt u de ervaringen van de bezoeker op al uw aanraakpunten om een naadloze, consistente ervaring te bieden.
...
Velen van u willen [!DNL Target] wellicht gebruiken om verschillende digitale aanraakpunten te testen en aan te passen, zoals traditionele web- en mobiele aanraakpunten, maar ook aanraakpunten die geen browser hebben of geen JavaScript-code gebruiken. In sommige gevallen vereist het interne of externe beleid dat u extra controle- en beveiligingsniveaus hebt. U zou ook processen kunnen hebben die op een backendserver om prestatiesredenen moeten lopen. Om aan deze grote verscheidenheid van toepassingen te voldoen, geven wij u de capaciteit om [!DNL Target] op verschillende manieren uit te voeren: client-side, server-side of een combinatie van beide.

| Type implementatie | Details |
| --- | --- |
| Client-kant | Met deze implementatie van [!DNL Target] biedt [!DNL Target] de ervaringen die met een activiteit zijn gekoppeld rechtstreeks aan de clientbrowser. De browser bepaalt welke ervaring wordt weergegeven en geeft deze weer. Met cliënt-kant, kunt u een redacteur WYSIWYG, **[!UICONTROL Visual Experience Composer]** (VEC), of een niet-visuele interface, **[!UICONTROL Form-based Experience Composer]**, gebruiken om uw test en verpersoonlijkingservaringen tot stand te brengen. [Meer](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md) informatie. |
| Server-kant | Bij dit type [!DNL Target]-implementatie vraagt een clientapparaat om een ervaring via uw server, verzendt de server die aanvraag naar [!DNL Target], [!DNL Target] stuurt de reactie terug naar uw server en bepaalt de server welke ervaring er is om te leveren aan het clientapparaat voor het renderen. De ervaring hoeft niet in een browser te worden weergegeven. het kan in een e-mail of kiosk, via een stemmedewerker, of door één of andere andere niet-visuele ervaring of niet op browser-gebaseerd apparaat tonen. Aangezien uw server zich tussen de client en [!DNL Target] bevindt, is dit type implementatie ook ideaal als u meer controle en beveiliging nodig hebt of complexe back-endprocessen hebt die u op uw server wilt uitvoeren. [Meer](/help/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md) informatie. |
