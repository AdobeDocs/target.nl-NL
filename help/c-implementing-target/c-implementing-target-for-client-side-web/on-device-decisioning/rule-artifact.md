...
Het regelartefact is een JSON-representatie van uw [!DNL Adobe Target]-besluitvormingsactiviteiten op het apparaat. Het regelartefact wordt geproduceerd door [!DNL Target] en aan Akamai CDN verspreid om ervoor te zorgen er een regelartefact beschikbaar zo dicht mogelijk aan uw bezoekers is. Het regelartefact bevat metagegevens die ervoor zorgen dat uw activiteiten exact worden uitgevoerd en uitgevoerd en die tevens realtime analyses via het bijhouden van gebeurtenissen mogelijk maken.
