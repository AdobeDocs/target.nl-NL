...
description: Gebruik de functie adobe.target.getOffer() en de bijbehorende opties voor de Adobe [!DNL Target] at.js library to fire requests to get a [!DNL Target] aanbieding.
