...
description: Gebruik adobe.target.sendNotifications() voor at.js om meldingen naar de doelrand te verzenden wanneer een ervaring wordt weergegeven zonder applyOffer(s). (js.2.1 +)
