...
description: Gebruik adobe.target.sendNotifications() for at.js om meldingen naar de  [!DNL Target] edge te verzenden wanneer een ervaring wordt weergegeven zonder applyOffer(s) te gebruiken. (js.2.1 +)
