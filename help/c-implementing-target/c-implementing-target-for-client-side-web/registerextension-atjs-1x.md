...
description: Informatie over de functie registerExtension() voor de Adobe Target op .js JavaScript-bibliotheek.
title: Informatie over de functie registerExtension() voor de Adobe Target in.js JavaScript-bibliotheek.
...
Voor meer informatie en voorbeelden van hoe te om te gebruiken `registerExtension`, zie de pagina van de Uitbreidingen van de Doelen van het Doel van de [](https://github.com/Adobe-Marketing-Cloud/target-atjs-extensions) Wolk van de Ervaring van Adobe op GitHub.
