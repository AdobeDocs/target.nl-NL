   ...
   + Client-kant web: Doel {#client-side} implementeren
      ...
      + at.js-implementatie {#at-js-implementation}
         + Apparaatbeslissingen {#on-device-decisioning}
            ...
            + [Problemen oplossen](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/troubleshooting-on-device-decisioning.md)
         ...
         + Hoe te opstellen bij.js {#deploy-at-js}
            ...
            + [Doel implementeren met Platform launch](c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md)
